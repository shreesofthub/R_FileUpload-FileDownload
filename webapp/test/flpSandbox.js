		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Upload the files using fileuploader and save into backend",
									"targetURL": "#r6fileuploader-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"r6fileuploader-display": {
								"semanticObject": "r6fileuploader",
								"action": "display",
								"description": "Upload the files using fileuploader and save into backend",
								"title": "Upload the files using fileuploader and save into backend",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=r6fileuploader",
									"url": sap.ui.require.toUrl("r6fileuploader")
								}
							}
						}
					}
